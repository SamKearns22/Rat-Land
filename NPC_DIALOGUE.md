...
`WORLD.md`. Twenty-nine rats plus four mice (Pip, Chalky Stubbs, Crazy
Joe, Ken Choppings), plus the Town Crier (rat, tracked separately from
the roster). Each entry includes a
...
**Renamed in the most recent pass** (see the "New Name" column of the
source rename/dialogue file): most of the roster below now goes by a
new name. A few entries kept their original name outright (no new name
...
### Captain Aldus (was Colonel Bartholomew Nutkin)
**Stance:** Founding-war veteran, sincerely proud, nostalgic for the conflict with Grimmal that founded Rat Land.
...
### Grismond (was Gristle)
**Stance:** Pro-separation, blunt and hostile. Rough dockside rat.
...
### Aurora Thistlewood-Vole (was Marguerite Thistlewood-Vole)
**Stance:** Pro-open-borders, posh, openly contemptuous of bigotry — the sharpest counter-voice in the group.
...
### Pip
**Stance:** Young mouse migrant from Mousika, earnest, just wants honest work and to feel welcome.
...
### Bill Arnold (was The Drain-Watcher)
**Stance:** Cynical / apathetic about the entire political mess, invested in neither side.
...
### Twitchy Nostrum
**Stance:** Conspiratorial. Convinced the whole debate is a distraction engineered by someone, somewhere.
...
### Ferdy Cobb
**Stance:** Economic anxiety over cultural resentment — sympathetic to mice individually, resents the labor competition, openly cynical about the refugee/economic-migrant distinction.
...
### Sister Bramble
**Stance:** Volunteers at the Intake Culvert through the Church of the Rat God. Warm, welcoming, unshaken. Sprite switched to the rat pack this pass (was drawn as a mouse).
...
### Fen Wicket
**Stance:** Keeps the toll-house by one of the bridges; hardened against informal river crossings. Overworld dialogue only — his battle/combat dialogue (`battleOpinion` and the fight itself) is untouched by this pass.
...
### Giselle Tomiyak (was Dredge)
**Stance:** Went through the "proper channels" herself years ago and is bitter that new arrivals seemingly don't have to.
...
### Kathy Vole (was Mrs. Pemberton-Vole)
**Stance:** Cheese-shop crime front and crossing-smugglers, gossip angle. Deals entirely in rumor and innuendo.
...
### Otis Littlefoot (was Wetherby)
**Stance:** Town Hall clerk, professional information-haver, gossips about the old mayor's ouster.
...
### Corporal Nettle
**Stance:** Cockroach Nation war, resentment angle. Unchanged this pass.
...
**Exchange — Corporal Nettle and Bill Arnold (was the Drain-Watcher):**
> **Corporal Nettle:** "They want another tithe for the roach business. Third one this year."
> **Bill Arnold:** "The roach business. Right. Is that near here?"
> **Corporal Nettle:** "Nowhere near here. That's rather my point."
> **Bill Arnold:** "Then I've got a solution for you: don't think about it. Works for me."

### Barry Gutt
**Stance:** Ratxit and anti-mouse populism, loud-and-proud angle. No new name given this pass — dialogue only.
...
### Doreen Chunderghast (was Doreen)
**Stance:** Runs the counter at Rat Café. Warm, generous, unbothered.
...
### Sooty Lowes and Chalky Stubbs (was Sooty and Chalky)
**Stance:** Football rivals — Culvert 6 West vs. Pipe 17 Rovers. Light, needling, entirely apolitical. Chalky's sprite switched to the mouse pack this pass (was drawn as a rat); no scripted in-game link between the two (each cycles independent lines).
...
### Maisey Gray (was Old Fenwick)
**Stance:** Cost-of-living grumbler, wry about slipping down the class ladder.
...
### Vinnie Sputtings (was The Scrap Grumbler)
...
### Les Drainshaw (was The Countryside Dreamer)
**Stance:** Wistful about the surface — real grass, real soil, someday. Keeps a sewer garden in the meantime.
...
### Nora Sopwell and Nivvey Trench (was Nora Sopwell and Barry Trench)
**Stance:** Linked conversational pair — a married couple's bicker. Stand
directly adjacent to each other in-game; a single Talk interaction
...
**Exchange:**
> **Nivvey:** "Love, don't be out there pretending like you aren't snacking with the girls at the office. Every day is cake day in there."
> **Nora:** "What do you mean, I eat too much? You can't just say that to a girl! Besides, you're the one who does all the cooking!"
> **Nora:** "I'm not sure you realise how horrible you're being."
> **Nivvey:** "No, I'm perfectly aware, love."

### Emily Cricket (was The Queue Complainer)
**Stance:** Perpetually behind someone slow at Rat Café — now openly, bitterly sarcastic about it rather than just grumbling.
...
### Charlene Gray (was The Parade Gossip)
**Stance:** Excited about the 20th anniversary parade and its history-themed floats.
...
### Archie Lott (was The Bin Day Grumbler)
**Stance:** Domestic mishaps and a marriage in mild crisis, more than actual bin day complaints now.
...
## Outsider — Ken Choppings (mouse)

### Ken Choppings (was Kevin)
**Stance:** Defensive, quick to expect trouble, re-themed this pass from a
weary/good-humored outsider to a sharper, more confrontational read —
bristles fast, but talks himself back down by the end.
